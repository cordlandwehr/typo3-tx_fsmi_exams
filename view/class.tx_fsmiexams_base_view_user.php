...
class tx_fsmiexams_base_view_user extends tslib_pibase {
	...
	function switchViewMenu() {
		...
		$content .= $this->pi_linkTP($this->LANG->getLL("tt_content.list_type_controller_browse.list"),
						array (	self::extKey.'[type]' => self::kVIEW_TYPE_LIST));
		$content .= ' / ';
		$content .= $this->pi_linkTP($this->LANG->getLL("tt_content.list_type_controller_browse.aggregated"),
				array (	self::extKey.'[type]' => self::kVIEW_TYPE_AGGREGATION));
		$content .= ' / ';
		$content .= $this->pi_linkTP($this->LANG->getLL("tt_content.list_type_controller_browse.folderview"),
